...
export const Interval = () => (
    <>
        ...
        <P style={ toggleULStyles }>
        El 1 de abril, sobre el final de un día bueno, descubrí en internet que el acetato de fludrocortisona es mineralocorticoide y glucocorticoide a la vez y el panoraba parecía empezar a aclararse, como digo a continuación. A la noche estornudaba.
        </P>

        <P style={ toggleULStyles }>
        El 2 de abril estaba muy bien, salvo por un poco de Cushing. Tuvo control con el endocrinólogo a las 12 hs, primera vez que se la llevaba desde enero, que quedó sorprendido por lo bien que la vio. Hablamos principalmente de la infección y coincidimos en eliminar la prednisolona.
        </P>

        <P style={ toggleULStyles }>
        Los 4 días finales están marcados por signos de Cushing alto a pesar del mitotano, del retiro de la prednisolona y de la reducción de dosis de fludrocortisona a 90 microgramos. Junto con el Cushing, había fluidos de la infección y una manera voraz de beber, y a veces temblaba al comer hueso, como con alguna dificultad motriz o un pico de ansiedad o presión arterial.
        </P>
