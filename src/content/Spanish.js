...
export default function Spanish() {
    ...
    <>
        ...
        <P>
        Por eso me tocó predecir con lastimoso éxito que si le daba antibióticos líquidos en la boca a mi perra, y que si le diluía ahí los corticoides, iba a tener ataques de estornudos, por si quedaba alguna duda. Pasó sus últimas semanas estornudando a cada rato, salvo cuando tenía signos de Cushing alto. El resto es explicar, al menos como excusa, por qué cuesta tanto esconder drogas en la comida de una perra tan chica, de estómago cerrado y harta de tantas drogas.
        </P>
