...
export const Intro = () => {
    ...
    <P>
    {!isEnglish ? <>
        Los signos de la enfermedad se pueden rastrear a poco después de la traumática castración, cuando tenía 5 años y 9 meses. El diagnóstico se demoró por pura impericia profesional, que se mostró incapaz de asociar síntomas con enfermedad y de hacer los estudios que sí podían explicar el problema. Luego fue perfectamente controlada con un inhibidor de corticoides llamado trilostano, de poca experiencia en el mercado (data de 2006). El tumor ya era inoperable para cuando fue descubierto porque estaba invadiendo la luz de la vena cava inferior y toda cirugía en esa zona es garantía de desangrado. Tuvo, entonces, un año y medio en completa salud.
        </>:<>
        Signs of the disease can be traced back to shortly after the traumatic castration, when she was 5 years and 9 months old. The diagnosis was delayed due to professional incompetence, who proved unable to associate symptoms with disease and to carry out the studies that could explain the problem. Then it was perfectly controlled with a corticosteroid inhibitor called trilostane, with little experience on the market (dating from 2006). The tumor was already inoperable by the time it was discovered because it was invading the inferior vena cava and any surgery in that area is a guarantee of exsanguination. She had, then, a year and a half in complete health.
    </>}
    </P>
    ...
    <P>
    {!isEnglish ? <>
        Finalmente, el día 60 del tratamiento la llevé a hacer una tomografía computada para saber cómo marchaba pero murió ahí. Ella ya no tenía capacidad de producir sus propios corticoides para esa fecha por causa de la naturaleza del tratamiento que estaba haciendo y probablemente necesitaba recibir corticoides inyectables de efecto inmediato para salir de la crisis respiratoria en la que la metieron el estudio con sedantes y el temor. Pero los veterinarios del centro no me escucharon, me combatieron y prevalecieron. Fue eutanasiada mientras reposaba su cabeza en mi mano.
        </>:<>
