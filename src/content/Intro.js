...
export const Intro = () => {
    ...
    {!isEnglish ?
        ...
        :
        <P>
        Signs of the disease can be traced back to shortly after the traumatic castration, when she was 5 years and 9 months old. The diagnosis was delayed for a year and a half due to sheer professional incompetence, who proved unable to associate symptoms with disease and to carry out the studies that could explain the problem. Then it was perfectly controlled with a corticosteroid inhibitor called trilostane, with little experience on the market (dating from 2006). The tumor was already inoperable by the time it was discovered because it was invading the lumen of the inferior vena cava and any surgery in that area is a guarantee of exsanguination. He then had the best year and a half of his life, in complete health.
        </P>
    }
    ...
    {!isEnglish ?
        ...
        :
        <P>
        But after that year and a half it was noticed that the daily dose of trilostane he was receiving was insufficient. The expectation of tumor growth was betrayed by an ultrasound that revealed, instead, a risk of secondary tumors in the liver, between one and two centimeters in diameter. Forty days later and in the midst of aggressive treatment with the chemotherapeutic drug mitotane, a chest X-ray revealed multiple metastases in both lungs.
        </P>
    }
    ...
    {!isEnglish ?
        ...
        :
        <P>
        I am sure that the information I needed was in the university libraries. At the same time, I also believe that surfing the Internet eliminated the institutional monopoly of practical knowledge, but only to the extent that many take the trouble to write it down so that it is accessible; and, consequently, he eliminated the denigrating slavery of the common man to the professional of medical services, to his virtues, to his imbecilities, to his knowledge, to his ignorance, to his successes, to his mistakes; for better and for worse.
        </P>
    }
