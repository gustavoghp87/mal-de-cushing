...
export default function Spanish() {
    ...
    <div>
        ...
        <P>
        Para diciembre de 2021, tenía signos evidentes de Cushing y pedí otra ecografía doppler, mientras le subía un poco la dosis de trilostano. Aparte, había una bolita palpable del lado izquierdo del abdomen, chica pero firme. Empecé a pensar que le estaba llegando la hora.
        </P>
        ...
        <P>
        El mitotano cuesta cerca de 1,63 dólares los 100 mg. Un perro sin metástasis necesitaría algo así como 2 mil miligramos en la etapa de inducción por cada kilo de animal, o sea 33 dólares por kilo, en un tratamiento que dura un mes y medio. Luego queda un consumo semanal de mantenimiento de 100 mg por kilo, más el costo de los corticoides que calculo en 5 dólares por mes por kilo.
        </P>
        ...
        <P>
        Comentario aparte, leí de perros que eutanasiaron en pleno tratamiento al conocerse que tenían metástasis hepáticas. No leí de ningún perro con esta situación que se haya salvado.
        </P>
        
        <P>
        La llamada “etapa de inducción”, que culmina con la destrucción de la mayor parte del carcinoma suprarrenal y con la suplementación con corticoides externos, demora algo así como una semana cuando no hay metástasis, pero demora entre 2 y 11 semanas cuando sí hay metástasis, según los ensayos clínicos que pude leer. Por tanto, retirar el inhibidor de corticoides un día antes de introducir el mitotano es garantía de desastre.
        </P>
        ...
        <P>
        Por supuesto, los distintos veterinarios que la vieron recetaron distintos antibióticos que para lo único que sirvieron fue para limpiarle el sarro de los dientes, y algunas cosas negativas que cuento después.
        </P>
        
        <P>
        Resumiendo: Ella consumió 10 mg por día en las primeras semanas desde el diagnóstico de Cushing, subió a 15 después, al año el estudio desoído por mí dijo que esa cantidad ya no alcanzaba, al año y medio le subí como a 18 por la vuelta del Cushing, y le dimos 30 diarios en la semana previa al comienzo de la quimioterapia, para cortarlo completamente. Considerar que pesaba 5 kg al principio, bajó rápido a 3,3 kg y subió a 3,5 kg ya en el 2022.
        </P>
        ...
        <P>
        A las 4 horas de empezada la crisis comenzó a calmarse y respirar mejor. La traje devuelta, y le llevó como una hora más normalizarse. La crisis terminó como a las 4 de la mañana y duró como 6 horas. Era hora de una placa de tórax.
        </P>
        
        <P>
        La placa fue el lunes 28, feriado, y mostró una profusa nube de tumores en ambos pulmones. Fue muy duro pero decidí mudarme con ella para poder subir la dosis de mitotano y monitorear sus signos todo el tiempo. También para poder cargar yo mismo con la posibilidad de un colapso, la necesidad de trasladarla de urgencia y una posible eutanasia. El 2 de marzo me mudé, con pocas cosas y mis gatos.
        </P>
        ...
        <P>
        No puedo decir que me haya ido bien pero al final de cuentas quedó todo indefinido; todo puede ser. Así que seré objetivo. Era jueves 3 de marzo de 2022.
        </P>
        
        <P>
        Comenzó preguntando quién la estaba atendiendo y haciendo seguimiento. Le molestó notoriamente cuando le dije que un endocrinólogo, cuando él esperaba un oncólogo. Creo que se sintió atacado, invadido, y se comportó como el conocido mecánico de autos que levanta el capó y critica irresponsablemente el trabajo del que trabajó antes que él.
        </P>
        ...
        <P>
        Como tal, la única esperanza estaba en una quimioterapia convencional, esas que destruyen a las células cancerígenas pero también la médula ósea, invalidando las defensas del cuerpo, preparándolo para la siguiente expansión del cáncer, esta vez sin resistencia, y causa la muerte casi siempre.
        </P>
        
        <P>
        Yo estaba bien advertido que la frecuencia de éxito de las quimioterapias convencionales no supera el 4% en humanos y que es algo que los profesionales mandan a hacer solo para que parezca que están haciendo algo y que no se venga abajo la imagen que los simples mortales tienen de ellos. No le iba a hacer eso a mi perra.
        </P>
        ...
        <P>
        La demora del mitotano en destruir las cortezas adrenales y en causar una insuficiencia de corticoides era la mejor demostración que yo tenía de la veracidad del diagnóstico del endocrinólogo. Pero el oncólogo tenía que redoblar la apuesta: negó a muerte que el mitotano sea una droga quimioterapéutica. Para él, era una droga endocrinóloga para la regulación de hormonas y jamás podría hacerle daño a un tumor.
        </P>
        ...
        <P>
        Me fui muy golpeado. Dudé de todo, del tipo de cáncer, del mitotano y del endocrinólogo, y creí que Ally estaba a punto de colapsar. Ella contenta de viajar en taxi.
        </P>
        
        <P>
        Cuando me repuse un poco me puse a investigar. Que el mitotano hace quimioterapia lo dicen todos los sitios que hablan del tema. Conseguí un informe que resumía más de una década de tratamientos con mitotano en perros de una universidad. Los números de supervivencia no son demasiado optimistas pero me quedó claro que el mitotano sí puede destruir tumores adrenales y metástasis pulmonares, al menos.
        </P>
        
        <P>
        Y respecto al diagnóstico alternativo del oncólogo, leí que los tumores que se originan en el hígado son mucho menos frecuentes que los que llegan como metástasis, y que, en caso de ocurrir, uno esperaría ver un tumor grande en vez de muchos pequeños.
        </P>
        ...
        <P>
        El mitotano se usa para tratar el mal de Cushing en animales desde los años 60. Lo común nunca fue hacer una quimioterapia que cause insuficiencia de corticoides para después suplementar con corticoides sintéticos (terapia de reemplazo) sino que lo normal siempre fue dar una dosis diaria moderada para causar una destrucción parcial diaria sobre la corteza tumorosa, forzándola a producir menos corticoides, y nada más. El trilostano hace el mismo servicio pero a través de una inhibición de las glándulas, sin causar destrucción.
        </P>
        
        <P>
        Parece que en los ensayos clínicos que se hicieron, ambas terapias dieron resultados similares solo que el mitotano causa más efectos secundarios como vómitos, diarrea, náuseas e intolerancia a largo plazo. Por eso el trilostano salió victorioso y vivimos hoy en la era del trilostano. Pero esto no sale gratis, y que se preste atención: El mitotano tiene la capacidad de destruir metástasis incipientes. En cambio, como en el caso de Ally, tomar solo el inhibidor puede hacer que el cuerpo se llene de tumores en poco tiempo sin que se note, salvo que se respete una rutina bimensual de estudio de por vida. Rutina que, a diferencia de la que me dieron a mí, sí tiene que incluir el estudio de los pulmones.
        </P>
        ...
        <P>
        En el taxi, cerca de llegar y a 30 minutos de viaje, comenzó a hacer ruido al ventilar, parecido a aquella vez que terminamos en urgencias pero más suave. Quise pensar que era sed, pero no bebió ni orinó.
        </P>
        
        <P>
        En la clínica quisieron ver la radiografía espantosa. Se lamentaron pero no cancelaron la tomografía ni mencionaron riesgos. Sí me dijeron que no usaban anestesia sino sedante.
        </P>
        ...
        <P>
        Habían pasado 3 días. Escuchó con atención lo que pasó en ese lugar. Por supuesto que no estuvo de acuerdo con lo que hicieron y mencionó eso que dije: “sedantes, corticoides y diuréticos la sacaban de la crisis”. Pero también dijo que el estado era terminal y que le quedaban pocos días de vida. Habló del hígado, no habló de los pulmones. Y me mostró el tumor primario y la ramificación en la vena en las imágenes de la tomografía en la laptop que llevé.
        </P>
